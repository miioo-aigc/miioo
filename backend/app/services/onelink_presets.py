...
ONECLICK_SEEDANCE_2_MINI_MODEL_ID = "doubao-seedance-2-0-mini-260615"
...
ONECLICK_PRESET_MODELS = [
    ...
    {"name": "豆包 Seed 2.1 Pro", "model_id": "doubao-seed-2.1-pro-260628", "category": "chat", "description": "文本生成 / 豆包 2.1 Pro 文本模型", "is_default": False},
    ...
    # 保留 Seedream 5.0 为默认入口，同时恢复 Kling 系列图片模型供现有页面按能力动态接入。
    ...
    {"name": "GPT-Image 2 - 稳定版", "model_id": "gpt-image-2", "category": "image", "description": "图像生成 / 支持文本、图片输入并输出图片 / 稳定版 / 通过新版兼容接口透传 image_urls", "is_default": False},
    {"name": "GPT-Image 2 - 逆向版", "model_id": "sp-gpt-image-2", "category": "image", "description": "图像生成 / 支持文本、图片输入并输出图片 / 逆向版 / 通过新版兼容接口透传 image_urls", "is_default": False},
    ...
    {"name": "Kling V3 图像生成", "model_id": "image-kling-v3", "category": "image", "description": "图像生成 / 文生图、多图参考生图与扩图能力的统一入口 / 当前页面按能力收敛输入", "is_default": False},
    {"name": "Kling V3 图像 Omni", "model_id": "image-kling-v3-omni", "category": "image", "description": "图像生成 / 对接 OneLinkAI Kling 图像 Omni 接口 / 单图参考与主体补全", "is_default": False},
    {"name": "Vidu Q2 图像生成", "model_id": "image-vidu-q2", "category": "image", "description": "图像生成 / 文生图与参考图生图共用 reference2image 入口 / 现有页面按能力收敛输入", "is_default": False},
    # 保留 Seedance 2.0 / Fast 为默认入口，同时恢复 Kling 系列视频模型供创作/分镜页按能力选择。
    ...
    {"name": "豆包·Seedance 2.0 Mini", "model_id": ONECLICK_SEEDANCE_2_MINI_MODEL_ID, "category": "video", "description": "视频生成 / 复用 Seedance 2.0 主链路 / 文生、首帧、首尾帧、多模态参考、视频编辑、延长视频 / 4-15 秒", "is_default": False},
    ...
    {"name": "Kling V3 视频生成", "model_id": "video-kling-v3", "category": "video", "description": "视频生成 / 文生、图生、多图参考与多镜头扩展的统一入口 / 当前页面按能力收敛输入", "is_default": False},
    ...
    {"name": "Vidu Q3 Pro 生视频", "model_id": "viduq3-pro", "category": "video", "description": "视频生成 / 文生视频、图生视频、首尾帧 / Q3 Pro 主力模型 / 1-16 秒", "is_default": False},
    {"name": "Vidu Q3 Turbo 生视频", "model_id": "viduq3-turbo", "category": "video", "description": "视频生成 / 文生视频、图生视频、首尾帧 / Q3 Turbo 更快版本 / 1-16 秒", "is_default": False},
    {"name": "Vidu Q3 Pro Fast 生视频", "model_id": "viduq3-pro-fast", "category": "video", "description": "视频生成 / 图生视频、首尾帧 / Q3 Pro Fast 快速版本 / 1-16 秒", "is_default": False},
