...
\restrict kFPysfXiNcM5OTajsRYYBs3hVWgFkDLYof9QNEeupCNTzZEJD5DOEHtB8ZUBniQ
...
DROP INDEX IF EXISTS public.ix_voices_style_trgm;
DROP INDEX IF EXISTS public.ix_voices_name_trgm;
DROP INDEX IF EXISTS public.ix_voices_emotions_trgm;
DROP INDEX IF EXISTS public.ix_voice_favorites_user_id;
DROP INDEX IF EXISTS public.ix_video_clips_user_project_video_url;
...
DROP INDEX IF EXISTS public.ix_users_display_id;
...
DROP INDEX IF EXISTS public.ix_subjects_project_type_sort_created_id;
...
DROP INDEX IF EXISTS public.ix_storyboards_project_sort_shot_created;
DROP INDEX IF EXISTS public.ix_storyboards_project_id;
DROP INDEX IF EXISTS public.ix_storyboards_project_episode_sort_shot_created;
DROP INDEX IF EXISTS public.ix_storyboards_episode_id;
DROP INDEX IF EXISTS public.ix_reference_audio_items_name_trgm;
DROP INDEX IF EXISTS public.ix_reference_audio_items_emotion_trgm;
DROP INDEX IF EXISTS public.ix_reference_audio_items_description_trgm;
DROP INDEX IF EXISTS public.ix_projects_user_updated_id_desc;
DROP INDEX IF EXISTS public.ix_projects_user_id;
DROP INDEX IF EXISTS public.ix_projects_name_trgm;
DROP INDEX IF EXISTS public.ix_projects_description_trgm;
...
DROP INDEX IF EXISTS public.ix_notifications_user_read_created_id_desc;
DROP INDEX IF EXISTS public.ix_notifications_user_id;
DROP INDEX IF EXISTS public.ix_notifications_user_created_id_desc;
DROP INDEX IF EXISTS public.ix_model_configs_user_id;
DROP INDEX IF EXISTS public.ix_model_configs_user_category_enabled_default;
...
DROP INDEX IF EXISTS public.ix_gen_tasks_user_status_created_id_desc;
DROP INDEX IF EXISTS public.ix_gen_tasks_user_project_created_id_desc;
DROP INDEX IF EXISTS public.ix_gen_tasks_user_id;
DROP INDEX IF EXISTS public.ix_gen_tasks_user_created_id_desc;
...
DROP INDEX IF EXISTS public.ix_compositions_project_user_status;
DROP INDEX IF EXISTS public.ix_compositions_project_id;
DROP INDEX IF EXISTS public.ix_audio_clips_user_project_audio_url;
DROP INDEX IF EXISTS public.ix_audio_clips_user_id;
DROP INDEX IF EXISTS public.ix_audio_clips_text_trgm;
DROP INDEX IF EXISTS public.ix_audio_clips_project_id;
DROP INDEX IF EXISTS public.ix_assets_user_project_type_deleted_created_id_desc;
DROP INDEX IF EXISTS public.ix_assets_user_project_deleted_created_id_desc;
DROP INDEX IF EXISTS public.ix_assets_user_id;
DROP INDEX IF EXISTS public.ix_assets_user_deleted_created_id_desc;
DROP INDEX IF EXISTS public.ix_assets_subject_id;
DROP INDEX IF EXISTS public.ix_assets_prompt_trgm;
DROP INDEX IF EXISTS public.ix_assets_project_id;
DROP INDEX IF EXISTS public.ix_assets_name_trgm;
...
CREATE TABLE public.users (
    ...
    registered_phone character varying(20),
    last_login_phone character varying(20),
...
--
-- Name: ix_assets_name_trgm; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX ix_assets_name_trgm ON public.assets USING gin (name public.gin_trgm_ops);
...
--
-- Name: ix_assets_prompt_trgm; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX ix_assets_prompt_trgm ON public.assets USING gin (prompt public.gin_trgm_ops);
...
--
-- Name: ix_assets_user_deleted_created_id_desc; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX ix_assets_user_deleted_created_id_desc ON public.assets USING btree (user_id, is_deleted, created_at DESC, id DESC);
...
--
-- Name: ix_assets_user_project_deleted_created_id_desc; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX ix_assets_user_project_deleted_created_id_desc ON public.assets USING btree (user_id, project_id, is_deleted, created_at DESC, id DESC);


--
-- Name: ix_assets_user_project_type_deleted_created_id_desc; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX ix_assets_user_project_type_deleted_created_id_desc ON public.assets USING btree (user_id, project_id, asset_type, is_deleted, created_at DESC, id DESC);
...
--
-- Name: ix_audio_clips_text_trgm; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX ix_audio_clips_text_trgm ON public.audio_clips USING gin (text public.gin_trgm_ops);
...
--
-- Name: ix_audio_clips_user_project_audio_url; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX ix_audio_clips_user_project_audio_url ON public.audio_clips USING btree (user_id, project_id, audio_url);
...
--
-- Name: ix_compositions_project_user_status; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX ix_compositions_project_user_status ON public.compositions USING btree (project_id, user_id, status);
...
--
-- Name: ix_gen_tasks_user_created_id_desc; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX ix_gen_tasks_user_created_id_desc ON public.gen_tasks USING btree (user_id, created_at DESC, id DESC);
...
--
-- Name: ix_gen_tasks_user_project_created_id_desc; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX ix_gen_tasks_user_project_created_id_desc ON public.gen_tasks USING btree (user_id, project_id, created_at DESC, id DESC);


--
-- Name: ix_gen_tasks_user_status_created_id_desc; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX ix_gen_tasks_user_status_created_id_desc ON public.gen_tasks USING btree (user_id, status, created_at DESC, id DESC);
...
--
-- Name: ix_model_configs_user_category_enabled_default; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX ix_model_configs_user_category_enabled_default ON public.model_configs USING btree (user_id, category, is_enabled, is_default);
...
--
-- Name: ix_notifications_user_created_id_desc; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX ix_notifications_user_created_id_desc ON public.notifications USING btree (user_id, created_at DESC, id DESC);
...
--
-- Name: ix_notifications_user_read_created_id_desc; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX ix_notifications_user_read_created_id_desc ON public.notifications USING btree (user_id, is_read, created_at DESC, id DESC);
...
--
-- Name: ix_projects_description_trgm; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX ix_projects_description_trgm ON public.projects USING gin (description public.gin_trgm_ops);


--
-- Name: ix_projects_name_trgm; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX ix_projects_name_trgm ON public.projects USING gin (name public.gin_trgm_ops);
...
--
-- Name: ix_projects_user_updated_id_desc; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX ix_projects_user_updated_id_desc ON public.projects USING btree (user_id, updated_at DESC, id DESC);


--
-- Name: ix_reference_audio_items_description_trgm; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX ix_reference_audio_items_description_trgm ON public.reference_audio_library_items USING gin (description public.gin_trgm_ops);


--
-- Name: ix_reference_audio_items_emotion_trgm; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX ix_reference_audio_items_emotion_trgm ON public.reference_audio_library_items USING gin (emotion public.gin_trgm_ops);


--
-- Name: ix_reference_audio_items_name_trgm; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX ix_reference_audio_items_name_trgm ON public.reference_audio_library_items USING gin (name public.gin_trgm_ops);
...
--
-- Name: ix_storyboards_project_episode_sort_shot_created; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX ix_storyboards_project_episode_sort_shot_created ON public.storyboards USING btree (project_id, episode_id, sort_order, shot_number, created_at);
...
--
-- Name: ix_storyboards_project_sort_shot_created; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX ix_storyboards_project_sort_shot_created ON public.storyboards USING btree (project_id, sort_order, shot_number, created_at);
...
--
-- Name: ix_subjects_project_type_sort_created_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX ix_subjects_project_type_sort_created_id ON public.subjects USING btree (project_id, type, sort_order, created_at, id);
...
--
-- Name: ix_users_display_id; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX ix_users_display_id ON public.users USING btree (display_id);
...
--
-- Name: ix_video_clips_user_project_video_url; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX ix_video_clips_user_project_video_url ON public.video_clips USING btree (user_id, project_id, video_url);
...
--
-- Name: ix_voices_emotions_trgm; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX ix_voices_emotions_trgm ON public.voices USING gin (emotions public.gin_trgm_ops);


--
-- Name: ix_voices_name_trgm; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX ix_voices_name_trgm ON public.voices USING gin (name public.gin_trgm_ops);


--
-- Name: ix_voices_style_trgm; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX ix_voices_style_trgm ON public.voices USING gin (style public.gin_trgm_ops);
...
\unrestrict kFPysfXiNcM5OTajsRYYBs3hVWgFkDLYof9QNEeupCNTzZEJD5DOEHtB8ZUBniQ
