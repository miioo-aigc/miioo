...
export function AssetsProjectDeleteModal({ projectName, onClose, onConfirm }) {
  return (
    <ModalShell onClose={onClose} width="360px">
      <div style={{ padding: '24px', display: 'flex', flexDirection: 'column', gap: '24px', boxShadow: '#00000099 0px 8px 32px' }}>
