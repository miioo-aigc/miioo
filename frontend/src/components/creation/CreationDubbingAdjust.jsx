...
export function DubbingAdjust({ speed, pitch, volume, onSpeedChange, onPitchChange, onVolumeChange, advancedEnabled = false, onAdvancedChange, promptCharacterCount = 0, hasTextSelection = false, disabled }) {
  ...
  return (
    <div ref={ref} style={{ position: 'relative', display: 'flex', alignItems: 'center', gap: '8px', flexShrink: 0 }}>
      ...
      {advancedEnabled && (
        <CreationDubbingAdvancedToolbar hasTextSelection={hasTextSelection} disabled={disabled} />
      )}
