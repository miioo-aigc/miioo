...
export default function ScriptOutlineWorkspace({ data, projectSettings, onResplit, onRegenerateEpisode, onAddEpisode, onPatchStructure, onDeleteEpisode, episodeActionLoading, episodeActionError, selectedModel }) {
