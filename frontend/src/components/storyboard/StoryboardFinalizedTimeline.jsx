...
export default function StoryboardFinalizedTimeline({ projectRatio = '16:9', shots = [], finalizedMap = {}, mediaLoadingMap = {}, selectedShotId = null, onSelectShot, onCreate, onPreview, onDownload }) {
