  ...
  generations.forEach((gen) => {
    ...
    gen.cards.forEach((card, cardIdx) => {
      ...
      groupedByDate[dateLabel].push({
        ...
        prompt: gen.prompt,
        model: gen.model,
        voiceName: gen.voiceName ?? card.voiceName,
        voiceId: gen.voiceId ?? card.voiceId,
        speed: gen.speed ?? card.speed,
        pitch: gen.pitch ?? card.pitch,
        volume: gen.volume ?? card.volume,
        advancedEnabled: gen.advancedEnabled ?? card.advancedEnabled,
        ratio: gen.ratio,
